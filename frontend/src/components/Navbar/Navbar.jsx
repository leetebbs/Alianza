...
const SubMenu = ({action, subMenu_link,subMenu_text}) => (
  <>
    <p onClick={action}><Link to={subMenu_link}>{subMenu_text}</Link></p>
  </>
);
const Navbar = () => {
  // NAVBAR menu options
  const Menu = () => (
    <>
    {/* HOME */}
    <p onClick={closeMenu}><Link to="/">Home</Link></p>
    {/* HOW IT WORKS */}
    <div className='display__SubMenu'>
      <p onClick={closeMenu}><Link to="/public-works">How it Works</Link></p>
    ...
    {/* PUBLIC WORKS */}
    <div className='display__SubMenu'>
      <p onClick={closeMenu}><Link to="/public-works">Public Works</Link></p>
      <div className='subMenu__hide'>
        <div className='subMenu__hide-item'>
          <SubMenu
            subMenu_link={`/incentives`}
    ...
    {/* TOOLS */}
    <div className='display__SubMenu'>
      <p onClick={closeMenu}><Link to="/public-works">Tools</Link></p>
      <div className='subMenu__hide'>
        <div className='subMenu__hide-item'>
          <SubMenu
            subMenu_link={`/incentives`}
    ...
    {/* TRANSPARENCY */}
    <p onClick={closeMenu}><Link to="/transparency">Transparency</Link></p>
    {/* INCENTIVES */}
    <p onClick={closeMenu}><Link to="/incentives">Incentives</Link></p>
  </>
);
